...
do
    screen -S test_colors_${SUP_LEV}_weaksup_paired -dm bash -c "CUDA_VISIBLE_DEVICES=9 python test_colors_weaksup_paired.py ${LOAD_DIR} ${RES_OUT_DIR} ${SUP_LEV} --cuda --num_iter 3; exec bash";
