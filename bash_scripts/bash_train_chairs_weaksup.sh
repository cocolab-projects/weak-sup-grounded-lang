...
do
    ...
    screen -S train_chairs_${SUP_LEV}_weaksup_hard -dm bash -c "CUDA_VISIBLE_DEVICES=1 python train_chairs_weaksup.py ${OUT_DIR}_hard ${SUP_LEV} --num_iter 3 --cuda --hard; exec bash";
done
