...
def elbo_multimodal(out):
    ...
    log_p_y_given_z = -score_label_logits(label_dist, out['y'], out['y_logits_z_y'])
    ...
    log_p_y_given_z = -score_label_logits(label_dist, out['y'], out['y_logits_z_xy'])
