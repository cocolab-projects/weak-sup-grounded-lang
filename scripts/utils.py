...
def loss_multimodal(out, batch_size, alpha=1, beta=10):
    log_p_x_given_z = -score_txt_logits(out['x'], out['x_logit_z_x'], out['pad_index'])
    ...
    elbo_x = alpha * log_p_x_given_z + kl_q_z_given_x_and_p_z
    ...
    elbo_y = beta * log_p_y_given_z + kl_q_z_given_y_and_p_z
    elbo_y = torch.mean(elbo_y)

    log_p_x_given_z = -score_txt_logits(out['x'], out['x_logit_z_xy'], out['pad_index'])
    ...
    elbo_x_given_y = alpha * log_p_x_given_z + kl_q_z_given_xy_q_z_given_y
    ...
    elbo_y_given_x = beta * log_p_y_given_z + kl_q_z_given_xy_q_z_given_x
